<%@ page import="com.urase.webapp.model.ContactType" %>
<%@ page import="com.urase.webapp.model.SectionType" %>
<%@ page import="com.urase.webapp.model.ListSection" %>
<%@ page import="com.urase.webapp.model.OrganizationSection" %>
<%@ page import="com.urase.webapp.util.DateUtil" %>
                    ...
                    <c:forEach var="org" items="<%=((OrganizationSection) section).getOrganizations()%>"
                        ...
                        <div style="margin-left: 30px">
                            <c:forEach var="pos" items="${org.positions}">
                                <jsp:useBean id="pos" type="com.urase.webapp.model.Organization.Position"/>
                                <dl>
